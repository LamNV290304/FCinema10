...
//         if (url.contains("MainPage.jsp")) {
//            res.sendRedirect("push");
//        }
//        if (session.getAttribute("admin") == null) {
//            if (!url.endsWith("Login.jsp") && !url.endsWith("push")) {
//                res.sendRedirect("Login.jsp?error=You must login first!");
//            }
//        } else {
//            if (url.endsWith("Login.jsp") || url.endsWith("login")) {
//                res.sendRedirect("push");
//            }
//            if (url.endsWith("EmployeesList.jsp")) {
