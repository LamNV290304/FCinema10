<%-- 
    Document   : footer
    Created on : Jun 19, 2024, 11:59:57 PM
    Author     : Dokkuhai
--%>
 ...
 <div class="footer_m bg_backo p_3">
   <div class="container-xl">
    <div class="footer_1 row">
	   <div class="col-md-3">
	     <div class="footer_1i">
		   <h3><a class="text-white" href="index.html"> <span class="bg_brow p-1 px-2">F</span> Cinemas</a></h3>
	...
	<div class="footer_2 row mt-4 text-center pt-4">
	  <div class="col-md-12">
	    <p class="mb-0 text-light">© 2024 FCINEMAS Project. All Rights Reserved | Design by <a class="col_brow fw-bold" href="https://www.facebook.com/dokkuhai3105">Dokkuhai</a></p>
	  </div>
	</div>
 </div>
 </div>
